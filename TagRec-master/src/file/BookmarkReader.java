...
public class BookmarkReader {
	...
	public boolean readFile(String filename) {	
		try {
			...
			while ((line = br.readLine()) != null) {
				...
				processUserData(userID, userData, tags, categories, wikiID, title, description);			
				// reset userdata
			...
			processUserData(userID, userData, tags, categories, wikiID, title, description); // last user
			br.close();
			return true;
		} catch (Exception e) {
	...
	private void processUserData(String userID, Bookmark userData, List<String> tags, List<String> categories, String wikiID, String title, String description) {
